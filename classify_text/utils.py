...
rdr_segmenter = VnCoreNLP("classify_text/vncorenlp/VnCoreNLP-1.1.1.jar",
                          annotators="wseg", max_heap_size='-Xmx5g')
...
def text_preprocess(document):
    ...
    # tách từ
    segment_sentence = rdr_segmenter.tokenize(document)
    words = []
    for sentence in segment_sentence:
