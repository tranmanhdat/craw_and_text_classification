...
# }
dict_type = {"thoi_su":"3","thoi_su":"2", "phap_luat":"6", "kinh_doanh":"11",
             "xe":"659", "nhip_song_tre":"7","van_hoa":"200017", "giai_tri":"10", "giao_duc":"13",
             "khoa_hoc":"661", "suc_khoe":"12"}
root = sys.argv[1]
...
for link, value in dict_type.items():
    start = time.time()
